...
if [[ "$(pwd)" != */python/ray/experimental/1f1b ]]; then
	echo "Please run in the python/ray/experimental/1f1b directory"
	exit 1
fi
...
output_path=results/xuhui_n2/llama3/ray/p2p_off/ov_off/exp_self
mkdir -p $output_path
...
python -m ray.experimental.1f1b.src.main.llama3.ray.p2p_off.ov_off \
